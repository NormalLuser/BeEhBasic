...
IN          = $1F41 ;$0200          ;*Input buffer
XAML        = $E2            ;*Index pointers
XAMH        = $E3
STL         = $E4
STH         = $E5
L           = $E6
...
pWAIT       LDA ACIA_SR     ;*Load status register for ACIA
            AND #$10        ;*Mask bit 4.
            BEQ    pWAIT    ;*ACIA not done yet, wait.
            PLA             ;*Restore A
...
MSG5        .byte "Enter 8000 R to return to Basic",0
MSG6        .byte "Hello World! Fifty1Ford did this!",0
 BRK
